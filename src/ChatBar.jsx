...
class ChatBar extends Component {
    ...
    render() {
        ...
        return (<footer className="chatbar" >
            <input type="text" name="username" onChange={this.props.handleNameInput} className="chatbar-username" placeholder="Your Name (Optional)" defaultValue={this.props.currentUser}/>
